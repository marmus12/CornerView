...
def layer3_last(input_dim1,input_dim2,input_dim3,filt_num,feats=None):   
...
def define_cepinet(sz_input,sz_input2,num_views,conv_depth,filt_num,learning_rate):

    ''' 4-Input : Conv - Relu - Conv - BN - Relu ''' 
    input_stack_90d = Input(shape=(sz_input,sz_input2,num_views), name='input_stack_90d')
    input_stack_0d= Input(shape=(sz_input,sz_input2,num_views), name='input_stack_0d')
#    input_stack_45d= Input(shape=(sz_input,sz_input2,num_views), name='input_stack_45d')
    input_stack_M45d= Input(shape=(sz_input,sz_input2,num_views), name='input_stack_M45d')
    num_stacks = 3
    with tf.variable_scope("4-Stream"):
        ''' 4-Stream layer : Conv - Relu - Conv - BN - Relu ''' 
        mid_90d = layer1_multistream(sz_input,sz_input2,num_views,int(filt_num))(input_stack_90d)
        mid_0d = layer1_multistream(sz_input,sz_input2,num_views,int(filt_num))(input_stack_0d)    
    #    mid_45d=layer1_multistream(sz_input,sz_input2,num_views,int(filt_num))(input_stack_45d)    
        mid_M45d = layer1_multistream(sz_input,sz_input2,num_views,int(filt_num))(input_stack_M45d)   
