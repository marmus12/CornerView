...
def define_epinet(sz_input,sz_input2,view_n,conv_depth,filt_num,learning_rate):
    ...
    mid_45d=layer1_multistream(sz_input,sz_input2,len(view_n),int(filt_num),do_vis=True,name="45d")(input_stack_45d)    
    ...
    outputs = feat_outs90d + feat_outs0d + feat_outs45d + feat_outsM45d + [output]
        
    model_512 = Model(inputs = [input_stack_90d,input_stack_0d,
                               input_stack_45d,input_stack_M45d], outputs = outputs)
